    ...
    <>
      <section id="about" className={`container ${styles.aboutSec}`}>
        ...
        <div data-aos="slide-up" className={styles.info}>
          ...
          <p>
            We tackle these problems with tailored solutions, merging
            cutting-edge tech and strategic insights. Our process starts with
            thorough research and data analysis, informing every development
            stage. Experienced designers craft engaging interfaces, while adept
            developers bring visions to life with scalable solutions. Rigorous
            testing ensures top-notch quality.We're committed to your success.
          </p>
        </div>
      </section>
    </>
